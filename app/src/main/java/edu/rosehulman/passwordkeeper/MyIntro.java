...
import edu.rosehulman.passwordkeeper.LoginFragment;
...
public class MyIntro extends AppIntro {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroCamplesSlider.newInstance(R.layout.app_intro1));
        addSlide(AppIntroCamplesSlider.newInstance(R.layout.app_intro2));
        addSlide(AppIntroCamplesSlider.newInstance(R.layout.app_intro3));
